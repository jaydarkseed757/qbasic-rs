...
200 IF S <= 2 * K OR S < T1 THEN M = M + 1: GOTO 320
...
2190 COLOR 7
2200 PRINT "               ÉÍËÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍ»"
2210 PRINT "               ÌÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍ¹"
2220 PRINT "               º º                                            º º"
2230 PRINT "               º º ";: COLOR 15: PRINT "                 KINGDOM                ";: COLOR 7: PRINT "   º º"
2240 PRINT "               º º                                            º º"
2250 PRINT "               º º ";: COLOR 15: PRINT "  COPYRIGHT (C) 1982  BY ENSIGN SOFTWARE ";: COLOR 7: PRINT "  º º"
2260 PRINT "               º º                                            º º"
2270 PRINT "               º º          2312 N. COLE RD, SUITE E          º º"
2280 PRINT "               º º          BOISE, ID  83704  U.S.A.          º º"
2290 PRINT "               º º DAY (208) 378-8086      EVE (208) 377-1938 º º"
2300 PRINT "               º º                                            º º"
2310 PRINT "               ÌÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍ¹"
2320 PRINT "               ÈÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍ¼"
